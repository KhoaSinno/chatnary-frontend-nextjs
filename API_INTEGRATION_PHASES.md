...
| 2026-09-04 | 4 / D2-D3 | Protected document preview/download now uses authenticated blob requests; public `/uploads` is removed. Ingest stores parser page count independently from embedding chunk count. | BE `ad718c0`, `646ebc0`; FE `ff40cec`, `760d3fc`; owner/viewer `200`, outsider/legacy `404`; BE Jest 11 suites/23 tests and both production builds pass. |
